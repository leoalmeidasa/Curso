...
echo "<pre>", print_r($instruments, true), "</pre>";
...
foreach ($acdc as $item) { //imprimindo valores
    echo "<p>{$item}</p>";
}

foreach ($acdc as $key => $value) { //imprimindo chave e os valores
    echo "<p>{$value} is a {$key} of band!</p>";
}


foreach ($rockBands as $rockBand) { //associando valores por uso de %s
