...
if($postArray) {
    if(in_array("", $postArray)) {
        ...
        echo "<p class='trigger warning'>E-mail informado nao e valido !</p>";        
    }else {
        $saveStrip = array_map("strip_tags", $postArray);//removendo scripts e codigos fontes
        $save = array_map("trim", $saveStrip);           //removendo espaços vazios
        var_dump($save);
